! Note that the functions in this qud pack have been modified to allow for multiple arguments 
subroutine aaaa
...
!
  ...
  call qk15i ( f, boun, inf, 0.0d0, 1.d0, result, abserr, defabs, resabs )
!
!  Test on accuracy.
!
  last = 1
...
!   dla = lst
    ...
    call qfour ( f, c1, c2, omega, integr, epsa, 0.0d0, limit, lst, maxp1, &
